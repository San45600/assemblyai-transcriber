...
type ProcessType = "waiting" | "processing" | "done";
  ...
  return (
    <div className="w-full bg-[#242424] h-full sm:flex-row flex flex-col py-4 sm:py-12 gap-4 overflow-y-auto">
      <div className="flex flex-col w-full items-center sm:justify-between gap-4 h-full">
        <Card className="w-[90%] bg-[#18181B] border-0 drop-shadow-xl">
          ...
          <CardFooter className="flex justify-start sm:justify-end gap-2">
            ...
            <Button
              variant={"secondary"}
              disabled={!transcript || process == "processing"}
              onClick={() => {
                if (!audioFile) return;
        ...
        <Card className="w-[90%] bg-[#18181B] border-0 drop-shadow-xl py-4 h-">
      ...
      <div className="w-full flex justify-center items-center flex-col gap-4 h-full">
        <Card className="w-[90%] bg-[#18181B] border-0 drop-shadow-xl py-6 h-full flex flex-col overflow-y-auto">
          <CardContent className="w-full h-full pb-0">
            {process == "waiting" ? (
              ...
              <div className="text-white h-fit rounded-lg flex gap-[5px] flex-wrap items-center ">
                {transcript &&
